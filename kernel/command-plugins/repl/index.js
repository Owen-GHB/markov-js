 ...
 */
export async function start(commandRoot, projectRoot, contextFilePath, historyFilePath, maxHistory) {
	const repl = getReplInstance();
	return await repl.start(commandRoot, projectRoot, contextFilePath, historyFilePath, maxHistory);
}
